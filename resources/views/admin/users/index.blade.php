...
<div class="card">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      ...
      <div>
        <button class="btn btn-primary" data-toggle="modal" data-target="#m-tambah">Input New Users</button>
      </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    <div class="form-group col-sm-12">
                        ...
                        <input v-model="form_tambah.username" type="text" class="form-control" required>
                    </div>
                    <div class="form-group col-sm-12">
                      <label class="col-sm-4 col-form-label">Password</label>
                      <input v-model="form_tambah.password" type="password" class="form-control" required>
                    </div>
                    <div class="form-group col-sm-12">
  ...
  var vue = new Vue({
    ...
    methods: {
      ...
      async loadDataTable(){
        ...
        let response = await axios.get('/users/fetch')
      ...
      async deleteData(item){
        ...
        if(confirmation){
          let response = await axios.delete('/users/'+item.id_user+'/destroy')
          this.loadDataTable();
        }
     
      },
      submitAdd(){
        if(this.form_tambah.username && this.form_tambah.password && this.form_tambah.is_active){

            let formData = new FormData();
            formData.append('username', this.form_tambah.username);
            formData.append('password', this.form_tambah.password);
