...
@section('dashboard_title', 'Books Borrow')

@section('content')
<div class="card">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      <h3 class="card-title">Books Available to Borrow</h3>
      <div>
  ...
  <div class="card-body">
    <table id="datatable" class="table table-bordered table-hover">
      ...
      <tr v-for="(item, index) in data">
        ...
        <td>
          <a href="#" class="btn btn-primary btn-xs">Borrow</a>
  ...
  var vue = new Vue({
    ...
    methods: {
      ...
      async loadDataTable(){
        ...
        let response = await axios.get('/books/fetch_available');
